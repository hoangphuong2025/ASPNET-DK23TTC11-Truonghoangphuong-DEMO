...
//******************************************************************************
    ...
    function scwSetDefaultLanguage()
        {try
            ...
            {// English
             ...
             scwArrMonthNames       = ['tháng1','tháng2','tháng3','tháng4','tháng5','tháng6',
    ...
    var scwTodayCellBorderColour = '#FFFFCC'; 
    ...
    document.writeln(
        '<style type="text/css">'                                       +
            ...
            '/* Calendar background */'                                 +
            'table.scw                  {background-color:  #A3A3A3;}'  +
            '/* Drag Handle */'                                         +
            ...
            'td.scwCellsExMonthDisabled {background-color:  #999999;'   +
                                        'color:             #666666;}'  +
            'td.scwNowDisabled          {background-color:  #CCCCCC;'   +
                                        'color:             #FFFFFF;}'  +
        '</style>'
                    );
...
// ***************************
    ...
    document.write(
     "<iframe class='scw' " + (scwID('scwIElt7')?"src='/default.aspx'":'') +
             "id='scwIframe' name='scwIframe' frameborder='0'>" +
     "</iframe>" +
     "<table   style=\"left:-200px;\"  id='scw' class='scw'>" +
       "<tr class='scw'>" +
         "<td class='scw'>" +
