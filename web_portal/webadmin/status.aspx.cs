...
{
    public partial class status : abcform
    {
        ...
        protected override  void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                if (UsersInfo!= null)
                {
                     ...
                     StatusController newsKindOfController = new StatusController();
                    if (string.IsNullOrEmpty(act))
                    {
                        ...
                        IList<StatusInfo> ilist = newsKindOfController.GetAll();
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            StatusInfo socialInfo = newsKindOfController.GetById(Util.convertToInt(sid));
                            if (socialInfo != null)
                            {
        ...
        protected void p_list_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                StatusInfo dataItem = (StatusInfo)e.Item.DataItem;
                if (dataItem != null)
                {
        ...
        protected void btnAdd_ckick(object sender, EventArgs e)
        {
            if (IsValid)
            {
                ...
                {
                    PANNELLIST.Visible = false;
                    StatusController socialController = new StatusController();
                   
                    if (string.IsNullOrEmpty(labelhiden.Text))
                    {
                        lblTitle.Text = StringApp.MSGCREATEDANHMUC;
                        StatusInfo socialInfo = getParam();
                    ...
                    {
                        StatusInfo socialInfo = socialController.GetById(Util.convertToInt(labelhiden.Text));
        ...
        private StatusInfo getParam()
        {
            StatusInfo socialInfo = new StatusInfo();
            socialInfo.NameVi = txt_namevi.Text;
            socialInfo.NameEn = txt_nameen.Text;
            socialInfo.Indexs = Util.convertToInt(txt_namevi.Text, 1);
            return socialInfo;
        }

        private StatusInfo getParamUpdate(StatusInfo socialInfo)
        {
            socialInfo.NameVi = txt_namevi.Text;
            socialInfo.NameEn = txt_nameen.Text;
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                sendDirect("status.aspx?pindex=1&n="+DateTime.Now.Ticks);
            }
        }
