<%@ Page Language="C#" MasterPageFile="~/admin.Master" AutoEventWireup="true" CodeBehind="product_status.aspx.cs" Inherits="web_portal.webadmin.product_status" Title="" %>
             ...
             <tr class="list_title">
              ...
              <ItemTemplate>                
                  <tr class="list_row">
                    ...
                    <td align="left" ><a href="product_status.aspx?act=view&pid=<%#Eval("Id")%>&nguid=<%=DateTime.Now.Ticks.ToString() %>"><%#Eval("NameVi")%></a></td>
                    <td align="left">
                          <%#Eval("NameEn")%>
                    </td>
                    <td align="left">
    ...
    <tr>
        <td align="center" style="padding-bottom:10px;padding-top:10px;">
            <asp:Button ID="btnAddList" runat="server"  CssClass="back_button main_sub"
                 OnClick="btnAddList_Click" Text="Thêm mới" Width="120" />&nbsp;<asp:Button
